...
const SignIn = () => {
    ...
    return(<Wrapper>
        ...
        <form onSubmit={submitHandler}>
            <LoginFormInput inputType="email" inputValue={emailInput} setInputFn={setEmailInput}/>
            <LoginFormInput inputType="password"inputValue={passwordInput} setInputFn={setPasswordInput}/>
